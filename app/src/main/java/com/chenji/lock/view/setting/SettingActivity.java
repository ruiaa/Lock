...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getWindow().setBackgroundDrawable(Util.getBackground());*/
        ...
        fragmentTransaction = fragmentManager.beginTransaction();
            fragCode=0;
            fragmentTransaction.add(R.id.common_fragment, new SettingFragmentList());
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if (fragCode == 0) {
                ...
                if (timeKeyBack - oldTimeKeyBack < 5) {
                    ...
                    Toast.makeText(SettingActivity.this, R.string.toast_key_back, Toast.LENGTH_SHORT).show();
                }
            } else {
                turnBack();
            }
    ...
    protected void onStop() {
        ...
        if (DataResolver.Exit_Lock&&Util.noRunningOnStop(this)){
            if (!State_Adding) {
                MyLog.i_chenji_log("setting exit");
                System.exit(0);
            }
        }
    }
...
/*    //监听活动条
    ...
    public void showDetailFrag(Fragment listFragment, int detailFragment) {
        ...
        switch (detailFragment) {
            case BACKGROUND: {
                fragmentTransaction.add(R.id.common_fragment, new SettingFragmentBackground());
                break;
            }
            case PASSWORD: {
                fragmentTransaction.add(R.id.common_fragment, new SettingFragmentPassword());
                break;
            }
            default:
                break;
    ...
    private static boolean State_Adding=false;
    ...
    public void changeBackground(String order) {
        getWindow().setBackgroundDrawable(Util.getBackground(order));
    }
